...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c106 = function(root, is_decorator, name, args, block) {
      ...
      peg$c164 = function(f) { return c(new n.NumericLiteral(parseInt(f.join(''), 10))); },
      peg$c165 = "$",
          ...
          if (s4 !== peg$FAILED) {
            ...
            if (s5 !== peg$FAILED) {
              ...
              if (s6 !== peg$FAILED) {
                s7 = peg$parseBlock();
                if (s7 !== peg$FAILED) {
                  s8 = peg$parsekeyword_end();
                  if (s8 !== peg$FAILED) {
                    peg$savedPos = s0;
                    s1 = peg$c106(s3, s4, s5, s6, s7);
                    s0 = s1;
                  } else {
                    peg$currPos = s0;
                    s0 = peg$FAILED;
