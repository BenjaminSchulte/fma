#ifndef __FMA_INTERPRET_STATICMEMBERCONTEXT_H__
#define __FMA_INTERPRET_STATICMEMBERCONTEXT_H__
...
class StaticMemberContext : public BaseContext {
public:
  StaticMemberContext(Interpreter *interpreter, const types::ClassPtr &object, const std::string &name);
