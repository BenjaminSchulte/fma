...
// ----------------------------------------------------------------------------
void MemorySymbolMap::addEmulatorBreakpoint(const symbol::SymbolReferencePtr &ref, bool notifyOnly, const std::string &comment) {
  breakPoints.push_back(plugin::MemorySymbolMapBreakpoint(ref, notifyOnly, comment));
}
